...
if (users === admin) {
  ...
  if (length === 1) {
    ...
    if (
      ...
      Bot.setProperty("channel1", prompt[0], "string")
      Bot.setProperty("channel4", prompt[1], "string")
      Bot.setProperty("channel3", prompt[2], "string")
      Bot.setProperty("channel2", prompt[3], "string")
    ...
    if (
      ...
      Bot.setProperty("channel2", prompt[4], "string")
    ...
    if (
      ...
      Bot.setProperty("channel1", prompt[0], "string")
      Bot.setProperty("channel5", prompt[1], "string")
      Bot.setProperty("channel3", prompt[2], "string")
      Bot.setProperty("channel4", prompt[3], "string")
      Bot.setProperty("channel2", prompt[4], "string")
